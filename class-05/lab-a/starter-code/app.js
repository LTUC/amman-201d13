...
var product = a * b;
var word = 'The product of ' + a + ' and ' + b + ' is ' + product + '.';
return[product, word];
}
...
function sumArray(sumArr) { //eslint-disable-line
  ...
  var b = sumArr[1];
  var c = sumArr[2];
  var d= sumAndMultiply(a,b,c);
  
  var resalt = a+","+b+","+c +" was passed in as an array of numbers, and "+ d[0] +" is their sum.";
...
function multiplyArray(multArr) { //eslint-disable-line
  ...
  var resalt = "The numbers "+a+","+b+","+c +" have a product of "+ d[1]+".";
