...
function multiply(a, b) { //eslint-disable-line
  var product = a*b;
  var resultString = 'The product of '+a+' and '+b +' is '+product+'.';
...
function sumArray(sumArr) { //eslint-disable-line
  ...
  var sumResult = sum(sum(sumArr[0], sumArr[1])[0], sumArr[2])[0];
   // string and second Index of Array
  var passMessage = sumArr + ' was passed in as an array of numbers, and ' + sumResult + ' is their sum.';
  return [sumResult,passMessage];
}
...
function multiplyArray(multArr) { //eslint-disable-line
  ...
  // first element of the return array calculate Product of 3 numbers in array 
  var multipleResult = multiply(multiply(multArr[0], multArr[1])[0], multArr[2])[0];
  // this is the second element of the array, the string
  var passMessage = 'The numbers '+multArr+' have a product of '+multipleResult+'.';
  return [multipleResult,passMessage];
