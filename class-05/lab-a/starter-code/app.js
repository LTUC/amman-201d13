...
Write a function called sum() that takes in two numbers as arguments and then returns an array where the first element t EXis the sum of those numbers, and the second element is a concatenated string thaACTLY follows this example and uses the values that were input into the function:
...
element is the sum of those three numbers, the second element is the product of those three numbers,  
...
and to do multiplication, use your multiply() function that you've already created. You're going to have to be resourceful to figure out 
...
already created. You're going to have to be resourceful to figure out how to do this. However, you may continue to use the + operator for 
...
You're going to have to be resourceful to figure out how to do this. This function should handle an 
